  ...
  return (
    <View className="waterbottle-page">
      ...
      <View className="refill-div">
        <View className="align-self-center flex">
          <TouchableOpacity
            disabled={refillNum <= 0}
            onPress={handleDecrease}
            className="refill-button gray"
          >
            <Text className="text-[50px]">-</Text>
          </TouchableOpacity>
          <Text className="sora align-self-center mx-10 text-[50px]">
            {refillNum}
          </Text>
          <TouchableOpacity
            disabled={refillNum >= 7}
            onPress={handleIncrease}
            className="refill-button green"
          >
