...
export default function ExpoForm() {
  ...
  const formFields = [
    { name: "name", placeholder: "Enter your name", icon: "person" },
  ...
  return (
    <View className="flex-1 justify-center px-6 bg-white">
      ...
      <Pressable
        ...
        disabled={!isValid}
      >
        <Text className="text-center font-semibold">Submit</Text>
      </Pressable>
      ...
      <Text>Already have an account? <Link href={'/pages/(auth)/login'}>Sign in</Link></Text>
    </View>
  );
}
